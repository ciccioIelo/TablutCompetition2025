 ...
 */
public class MyTablutAgentCopy extends TablutClient {

    private final AlphaBetaEngineCopy aiEngine;
    private final int timeoutInSeconds;

    public MyTablutAgentCopy(String player, String name, int timeout) throws IOException {
